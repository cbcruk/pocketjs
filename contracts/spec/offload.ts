...
export interface OffloadRequest { v: 1; id: number; method: string; payload: string; response?: "image" | "mesh" }
export interface OffloadImageTicket { token: number; width: number; height: number }
export interface OffloadReply { id: number; payload?: string; error?: string; image?: OffloadImageTicket; mesh?: OffloadMeshTicket }
...
export interface OffloadProviderReply { id: number; payload?: string; error?: string; image?: OffloadImage; mesh?: OffloadMesh }
...
export interface OffloadMesh { format: "mesh2d-v1"; bytes: Uint8Array }
export interface OffloadMeshTicket { token: number; width: number; height: number; bytes: number }
